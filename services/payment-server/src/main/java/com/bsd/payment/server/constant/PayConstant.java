package com.bsd.payment.server.constant;
...
public class PayConstant {
    ...
    public final static String CHANNEL_NAME_WX = "WECHAT";                // 渠道名称:微信
    ...
    public final static int TRANS_ERROR_INFO_MAX_SIZE = 128;//转账错误消息最大长度
    ...
    public static class WxConstant {
        ...
        public final static String TRADE_TYPE_JSAPI = "JSAPI";                                // 公众号支付或小程序支付
    ...
    public static final String PAY_CHANNEL_SERVICE_SUFFIX = "ChannelServiceImpl";
}
